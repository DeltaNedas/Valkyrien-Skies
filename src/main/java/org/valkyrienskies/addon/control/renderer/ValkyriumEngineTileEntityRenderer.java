...
public class ValkyriumEngineTileEntityRenderer extends
    TileEntitySpecialRenderer<TileEntityValkyriumEngine> {

    @Override
    public void render(TileEntityValkyriumEngine tileentity, double x, double y, double z,
        float partialTick,
