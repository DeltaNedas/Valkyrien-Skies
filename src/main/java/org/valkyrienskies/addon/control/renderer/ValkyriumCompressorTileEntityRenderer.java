...
public class ValkyriumCompressorTileEntityRenderer extends
    TileEntitySpecialRenderer<TileEntityValkyriumCompressor> {

    @Override
    public void render(TileEntityValkyriumCompressor tileentity, double x, double y, double z,
        float partialTick,
