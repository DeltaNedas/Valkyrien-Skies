...
public class GiantPropellerTileEntityRenderer extends
    TileEntitySpecialRenderer<TileEntityGiantPropeller> {

    @Override
    public void render(TileEntityGiantPropeller tileentity, double x, double y, double z,
        float partialTick,
